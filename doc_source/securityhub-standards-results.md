...
For example, if you do not collect forensics information, it is considered low severity\. This control can help to prevent future compromises, but the absence of forensics does not lead directly to a compromise\.  
