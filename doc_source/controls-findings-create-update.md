...
For findings generated by security checks, the [`Compliance`](asff-compliance.md) field in the ASFF contains the control\-related findings details\. The [`Compliance`](asff-compliance.md) field includes the following information\.
